#!/bin/bash
# Create a new root Certificate Authority (CA) if one does not exist.
...
debug "BEGIN Create Intermediate Certificate Authorities."
...
debug "END Create Intermediate Certificate Authorities."

# Copy the relevant certificates to desired locations.
