...
gitlab_rails['gitlab_email_display_name'] = 'A Gitlab Repository'
...
gitlab_rails['incoming_email_password'] = "ABIGSECRET"
...
gitlab_rails['db_database'] = "${GITLAB_PG_DB}"
...
gitlab_rails['redis_database'] = '${GITLAB_REDIS_DB}'
...
gitlab_rails['smtp_password'] = "ANOTHERBIGSECRET"
...
registry_nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.example.com/cert.pem"
registry_nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/gitlab.example.com/key.pem"
